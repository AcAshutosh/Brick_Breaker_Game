...
import 'package:brick_breaker_game/brick_breaker_game/cover_screen.dart';
import 'package:brick_breaker_game/brick_breaker_game/game_over_screen.dart';
import 'package:brick_breaker_game/brick_breaker_game/my_ball.dart';
import 'package:brick_breaker_game/brick_breaker_game/player.dart';
...
class _GameBoardBrickBreakerState extends State<GameBoardBrickBreaker> {
  ...
  void startGame() {
    ...
    // accelerometerEventStream(samplingPeriod: const Duration(milliseconds: 1000))
